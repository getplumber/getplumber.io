---
title: R2Devops v2.11 Release Notes
...
Set up your own AI model in the `Settings` > `Organization` > `AI Configuration` page, previously limited to Anthropic. This allows you to use your preferred AI provider.
