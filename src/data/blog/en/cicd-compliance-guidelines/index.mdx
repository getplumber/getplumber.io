...
- **A 25-point compliance checklist** you can use immediately
...
[StepSecurity Analysis](https://www.stepsecurity.io/blog/hackerbot-claw-github-actions-exploitation) | [Our dedicated article](/blog/hackerbot-claw-cicd-governance)
...
<div class="border-border/50 bg-background/50 my-6 space-y-5 rounded-xl border p-6">
  ...
  <div>
    ...
    <ol start="11" class="list-decimal space-y-1 pl-6">
  ...
  <div>
    ...
    <ol start="17" class="list-decimal space-y-1 pl-6">
...
| **Pipeline composition** (mandatory templates, pinned includes, override detection) | Template compliance reports, override alerts | Change management, Configuration management | Risk management measures | ICT change management | Secure by default |
...
5. **Start with the [25-point checklist](#cicd-compliance-checklist)** above, then map controls to your regulatory framework using the [mapping table](#control-mapping-iso-27001--nis2--dora--cra).
