...
5. **Put detection on autopilot**
   ...
   [Plumber](/docs/cli/github) ([ISSUE-802](/docs/cli/issues/ISSUE-802)), [zizmor](https://blog.stephane-robert.info/docs/pipeline-cicd/github/securite/zizmor/), and [poutine](https://blog.stephane-robert.info/docs/pipeline-cicd/github/securite/poutine/) catch these dangerous checkouts, so you do not regress.
...
- [Scan your GitHub Actions workflows with the open-source Plumber CLI](/docs/cli/github): dangerous triggers ([ISSUE-802](/docs/cli/issues/ISSUE-802)), template injection ([ISSUE-207](/docs/cli/issues/ISSUE-207)), and unpinned actions ([ISSUE-701](/docs/cli/issues/ISSUE-701)) are detected automatically.
