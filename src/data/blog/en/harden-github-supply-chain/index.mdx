...
First, download your binary and your `multiple.intoto.jsonl` from the release page, for example: [Plumber v0.1.68](https://github.com/getplumber/plumber/releases/tag/v0.1.68)
