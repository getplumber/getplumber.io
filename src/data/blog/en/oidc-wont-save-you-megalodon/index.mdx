...
- [Scan your GitHub Actions workflows with the open-source Plumber CLI](/docs/cli/github): unpinned third-party actions ([ISSUE-701](/docs/cli/issues/ISSUE-701)), over-broad permissions, and dangerous triggers are detected automatically.
