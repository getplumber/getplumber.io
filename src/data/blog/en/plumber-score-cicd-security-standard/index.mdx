...
<Image src={scorePageExample} alt="A project's official Plumber Score page, showing a D grade, the scanned repository, branch, and last update time" width={440} densities={[1, 2]} quality={92} class="mx-auto rounded-xl" />
