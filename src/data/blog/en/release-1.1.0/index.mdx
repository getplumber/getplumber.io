...
The manual install path is still fully supported for teams that prefer it or need advanced customization. Both options are covered in the [v1 installation documentation](/docs/legacy/v1/installation/docker-compose).
</Admonition>
