...
authors:
  - r2devops
pubDate: 2025-11-25
heroImage: ../shai-hulud/r2devops_dashboard.png
categories:
  - "News"
  - "CI/CD"
  - "Security"
...
- Pin third-party actions by commit SHA ([ISSUE-701](/docs/cli/issues/ISSUE-701)) and avoid unpinned package installs in workflows ([ISSUE-214](/docs/cli/issues/ISSUE-214)) — both are detected automatically by the [Plumber CLI for GitHub Actions](/docs/cli/github)

For a broader checklist, see our guide on [hardening your GitHub project's supply chain](/blog/harden-github-supply-chain).
...
For GitLab users, the same principles apply: lock down what runs during install jobs, scope CI tokens to the minimum, and continuously validate pipelines against your internal standards. The open-source [Plumber CLI scans GitLab CI/CD pipelines](/docs/cli/gitlab) for exactly these gaps — see our [5-minute hands-on walkthrough](/blog/hands-on-cli) to try it on your own project.
...
With the [Plumber Platform](/platform) teams use the CI/CD Compliance Dashboard to instantly spot which projects are not compliant with security best practices—before those gaps quietly become open doors for the next attack.

If you want to see what continuous CI/CD compliance looks like in GitLab, you can try Plumber in minutes.

![Plumber CI/CD Dashboard](./r2devops_dashboard.png)
