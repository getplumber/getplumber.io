...
This page covers the **GitHub Actions** particulars of the Plumber CLI: how to authenticate, the controls that ship for GitHub, the issues they emit, and a complete `github.controls:` configuration block. For installation, see the [Installation](/docs/cli/installation) page. For the provider-agnostic command reference, see the [main CLI page](/docs/cli).
