...
<Tabs defaultValue="import">
  ...
  <TabsContent value="import">
    ...
    5. **Use the component**
       ...
       ```yaml
       include:
         - component: gitlab.example.com/infrastructure/plumber/plumber@bec6c5b303bec2b5e18d1883d5eeba6432477a0b # pinned plumber version: v0.4.36
       ```
...
```yaml
include:
  - component: gitlab.com/getplumber/plumber/plumber@bec6c5b303bec2b5e18d1883d5eeba6432477a0b # pinned plumber version: v0.4.36
    inputs:
