...
<Tabs defaultValue="import">
  ...
  <TabsContent value="import">
    ...
    5. **Use the component**
       ...
       ```yaml
       include:
         - component: gitlab.example.com/infrastructure/plumber/plumber@v0.3.11
       ```
...
```yaml
include:
  - component: gitlab.com/getplumber/plumber/plumber@v0.3.11
    inputs:
...
gitlab:
  controls:
    ...
    # Optional: run gitleaks over the resolved pipeline configuration to
    # catch hardcoded secrets. Off by default because gitleaks is a
    # separate install.
