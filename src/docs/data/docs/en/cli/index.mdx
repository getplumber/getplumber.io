...
Pick the page for the platform you scan. Each is a complete, self-contained guide (installation, authentication, running a scan, the control catalog, the issues, and configuration):
