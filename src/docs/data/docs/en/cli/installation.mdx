...
<Tabs defaultValue="homebrew">
  ...
  <TabsContent value="homebrew">
    ...
    **Install a specific version:**
    ...
    ```bash
    brew install getplumber/plumber/plumber@0.4.41 # pinned plumber version
    ```

    <Aside variant="info">
      Versioned formulas are keg-only. Use the full path (e.g., `/usr/local/opt/plumber@0.4.41/bin/plumber`) or run `brew link plumber@0.4.41` to add it to your PATH. {/* pinned plumber version */}
    </Aside>
