...
<Tabs defaultValue="homebrew">
  ...
  <TabsContent value="homebrew">
    ...
    **Install a specific version:**
    ...
    ```bash
    brew install getplumber/plumber/plumber@v0.5.0 # pinned plumber version
    ```

    <Aside variant="info">
      Versioned formulas are keg-only. Use the full path (e.g., `/usr/local/opt/plumber@v0.5.0/bin/plumber`) or run `brew link plumber@v0.5.0` to add it to your PATH. {/* pinned plumber version */}
    </Aside>
  </TabsContent>
