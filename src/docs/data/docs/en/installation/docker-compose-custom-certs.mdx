---
title: Docker compose with custom certificates
description: This page describes how to set up a self-managed instance of Plumber using Docker-compose with custom certificates.
sidebar:
  order: 4
  label: Docker Compose (Custom Certs)
---
...
3. ### 📄 Configure Domain name
   ...
   Edit the `.env` file by updating value of `DOMAIN_NAME` and
...
6. ### 📄 Configure certificate
   ...
   Copy the fullchain and the private key
