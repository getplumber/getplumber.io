...
- [⏱️ Trying Plumber on your local computer using Docker-compose](/docs/installation/docker-compose-local)
- [🐳 Running Plumber using Docker-compose](/docs/installation/docker-compose)
- [🚀 Running Plumber on Kubernetes using a Helm chart](/docs/installation/kubernetes)
- [⏱️ Trying Plumber on your local computer using podman](/docs/installation/podman-local) (supported by community)
- [🕸 Running Plumber using podman](/docs/installation/podman) (supported by community)
