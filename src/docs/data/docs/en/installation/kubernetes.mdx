---
title: Kubernetes
description: This page describes how to run a self-managed instance of R2Devops on Kubernetes.
sidebar:
  order: 6
  label: Kubernetes
---
...
1. ### 📥 Initialize your cluster
   ...
   Create the namespace for R2Devops
   ```sh
...
3. You have successfully updated R2Devops 🎉
