...
description: This page describes how to quickly setup a self-managed instance of R2Devops for testing purposes using Docker-compose on your local computer.
sidebar:
  order: 5
