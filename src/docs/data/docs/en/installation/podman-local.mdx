---
title: Podman Local Installation
description: This page describes how to quickly setup a self-managed instance of Plumber for testing purposes using podman on your local computer.
sidebar:
  order: 6
  label: ➡️ Podman Local
---
