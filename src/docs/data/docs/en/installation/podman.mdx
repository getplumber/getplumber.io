...
<Aside variant="info">
This method is supported by [Plumber community](https://discord.getplumber.io/).
</Aside>
...
3. ### 📄 Configure Domain name
   ...
   ```bash title="Example with domain name 'plumber.mydomain.com' for Plumber and 'gitlab.mydomain.com' for GitLab" hl_lines="1-3"
...
6. ### 📋 (Optional) Add your custom CA
   ...
   <Steps>
   1. Add the CA certificate file in `podman ?`
   </Steps>
