...
| `PLUMBER_OIDC_ALLOWED_ISSUERS` | (empty) | Comma-separated GitLab base URLs allowed to push results |
...
| `PLUMBER_DB_MAX_OPEN_CONNS` | `10` | Maximum open connections in the pool |
...
| `PLUMBER_SYNC_MAX_VANISH_PERCENT` | `30` | Safety brake: abort a sync that would remove more than this share of projects |
| `PLUMBER_SYNC_MAX_VANISH_COUNT` | `10` | Safety brake: the absolute count below which the percentage brake does not apply |
