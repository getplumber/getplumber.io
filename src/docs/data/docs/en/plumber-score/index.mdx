...
<details>
<summary>Example of published output</summary>
...
1. Add the [GitHub Action](/docs/cli/github#live-score-badge) to your workflow
...
1. Add the [GitLab CI component](/docs/cli/gitlab#live-score-badge) to your
