...
with the correct workflow `permissions` and `score-push` enabled in the action
    ...
    jobs:
      plumber:
        steps:
          - uses: getplumber/plumber@4d8f35436d8c71cc2720fc6b513539ab18798e12 # pinned plumber version: v0.4.46
            with:
              score-push: true
    ```
...
`.gitlab-ci.yml` with the `score_push` input enabled
    ```yaml
    include:
      - component: gitlab.com/getplumber/plumber/plumber@d0ea3fd5db97b742830e3ae79a8d82b31a6e7727 # pinned plumber version: v0.4.46
        inputs:
          score_push: true
    ```
