...
with the correct workflow `permissions` and `score-push` enabled in the action
    ...
    jobs:
      plumber:
        steps:
          - uses: getplumber/plumber@222762895f59339b6b01fe3a0f34962b437bae15 # pinned plumber version: v0.4.49
            with:
              score-push: true
    ```
...
`.gitlab-ci.yml` with the `score_push` input enabled
    ```yaml
    include:
      - component: gitlab.com/getplumber/plumber/plumber@0a745591c345d6284edffb04dd975d9517af1f66 # pinned plumber version: v0.4.49
        inputs:
          score_push: true
    ```
