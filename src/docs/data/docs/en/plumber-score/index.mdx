...
with the correct workflow `permissions` and `score-push` enabled in the action
    ...
    jobs:
      plumber:
        steps:
          - uses: getplumber/plumber@7cc2c2fe18af5a9f55e28528b8fba0fecee3be79 # pinned plumber version: v0.4.56
            with:
              score-push: true
    ```
...
`.gitlab-ci.yml` with the `score_push` input enabled
    ```yaml
    include:
      - component: gitlab.com/getplumber/plumber/plumber@3b973b20d17f74c528ebd5f007f8a78aa417a096 # pinned plumber version: v0.4.56
        inputs:
          score_push: true
    ```
