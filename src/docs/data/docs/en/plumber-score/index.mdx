...
with the correct workflow `permissions` and `score-push` enabled in the action
    ...
    jobs:
      plumber:
        steps:
          - uses: getplumber/plumber@8481e54d04cd5d98523b07ddf3b66c6edbcce62a # pinned plumber version: v0.4.19
            with:
              score-push: true
    ```
...
`.gitlab-ci.yml` with the `score_push` input enabled
    ```yaml
    include:
      - component: gitlab.com/getplumber/plumber/plumber@09991091461c98eda3a541f8b78ff849f91819c2 # pinned plumber version: v0.4.19
        inputs:
          score_push: true
    ```
