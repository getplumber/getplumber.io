...
with the correct workflow `permissions` and `score-push` enabled in the action
    ...
    jobs:
      plumber:
        steps:
          - uses: getplumber/plumber@0f5c95e26fd7fc678fb4b45e321e74e0eb093994 # pinned plumber version: v0.4.20
            with:
              score-push: true
    ```
...
`.gitlab-ci.yml` with the `score_push` input enabled
    ```yaml
    include:
      - component: gitlab.com/getplumber/plumber/plumber@dadc641223202c5b97cb0b01dd097a0d0d9b4af2 # pinned plumber version: v0.4.20
        inputs:
          score_push: true
    ```
