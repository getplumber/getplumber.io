...
with the correct workflow `permissions` and `score-push` enabled in the action
    ...
    jobs:
      plumber:
        steps:
          - uses: getplumber/plumber@59d586ada029ab9691105c5a6aa803ef04c00d07 # pinned plumber version: v0.4.23
            with:
              score-push: true
    ```
...
`.gitlab-ci.yml` with the `score_push` input enabled
    ```yaml
    include:
      - component: gitlab.com/getplumber/plumber/plumber@5545608d4b0bfe26418f67654a6c8c23bd52be77 # pinned plumber version: v0.4.23
        inputs:
          score_push: true
    ```
