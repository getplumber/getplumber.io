...
with the correct workflow `permissions` and `score-push` enabled in the action
    ...
    jobs:
      plumber:
        steps:
          - uses: getplumber/plumber@10837e44cddfed934eaa2b509e677286af23e149 # pinned plumber version: v0.4.63
            with:
              score-push: true
    ```
...
`.gitlab-ci.yml` with the `score_push` input enabled
    ```yaml
    include:
      - component: gitlab.com/getplumber/plumber/plumber@87d187999c661dc737a7d5ef5df7b1a4f939307b # pinned plumber version: v0.4.63
        inputs:
          score_push: true
    ```
