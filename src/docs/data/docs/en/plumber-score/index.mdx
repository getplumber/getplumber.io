...
with the correct workflow `permissions` and `score-push` enabled in the action
    ...
    jobs:
      plumber:
        steps:
          - uses: getplumber/plumber@3a1f48049155c23725dc834c7b58884f7e5a86ae # pinned plumber version: v0.4.54
            with:
              score-push: true
    ```
...
`.gitlab-ci.yml` with the `score_push` input enabled
    ```yaml
    include:
      - component: gitlab.com/getplumber/plumber/plumber@2fa8d926634bc1e439e487bfa0e1786cb8266d09 # pinned plumber version: v0.4.54
        inputs:
          score_push: true
    ```
