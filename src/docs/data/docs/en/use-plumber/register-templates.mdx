---
title: Import CI/CD templates
description: Learn how to register and import CI/CD templates into your Plumber catalog.
sidebar:
  order: 3
  label: Import CI/CD templates
---

<Aside variant="info">
**What is a catalog?**

To use Plumber, you have to register your CI/CD templates and components in
your Plumber instance catalog. This is a registry of GitLab CI/CD templates
...
2. In this repository:
    <Steps>
    1. Create [`.r2.yml` file](#️-template-r2yml-file)
...
## ⚙️ Template `.r2.yml` file

Each template on Plumber must have its own `.r2.yml` file. It defines template
metadata.
...
add the `template_release` template in your repository CI/CD configuration.
