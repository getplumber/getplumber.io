---
title: GitLab Integration & Permissions
description: Learn about roles and permissions in Plumber.
sidebar:
  order: 4
...
To complete the Plumber onboarding process after installation, the user must have **Admin** access as defined below.
</Aside>
...
- **Who is Admin**:
    - If your **Plumber instance** is connected to an entire **GitLab self-managed instance**: any GitLab instance Admin.
    - If your **Plumber instance** is connected to a **GitLab group**: any user at least Maintainer in the root group.
...
- **Who is Member**:
    - If your **Plumber instance** is connected to an entire **GitLab self-managed instance**: any user logged into the GitLab instance.
    - If your **Plumber instance** is connected to a **GitLab group**: any user between Guest and Developer (included) in the root group.
...
Plumber uses GitLab tokens to communicate with your GitLab instance:
...
- If your **Plumber instance** is connected to an entire **GitLab self-managed instance**
    ...
    - If [Admin Mode](https://docs.gitlab.com/administration/settings/sign_in_restrictions/#admin-mode) is enabled on your instance
        ...
        - Option 2: the token owner must be **Maintainer** of all root groups and the token scope must be **`api`**
- If your **Plumber instance** is connected to a **GitLab group**
